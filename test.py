...
# print("==========Legal Documentation Assistant==========")
# agreement_type = input("Type of Agreement: ")
# name1 = input("Name of First Person: ")
# name2 = input("Name of Second Person: ")
# period = input("Period of Agreement(in days/months/years): ")
# terms = input("Terms of Agreement: ")

# query = (f"Draft a {agreement_type} agreement between {name1} and {name2} the period of their agreement will be of {period} and the conditions for the agreement will be {terms}")

# agent_chain = preprocessing()
# agent_chain.run(query)

# agent_chain.run("Draft a contract agreement between Ashwin and Shreesh for a period of 6 months, with conditions to start a car servicing business with equal share and 15 days prior information for leaving the partnership.")
